...
module.exports = __webpack_require__(/*! E:\Ionic\chickenHelper\src\main.ts */"zUnb");
...
/* harmony default export */ __webpack_exports__["default"] = (firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].firestore());
...
let AuthGuard = class AuthGuard {
    ...
    canActivate(route, state) {
        return this.auth.user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(user => {
            if (user)
                return true;
            else {
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_8__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["firebaseConfig"]), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_9__["AngularFireAuthModule"]],
...
let AuthService = class AuthService {
    constructor(fireAuth, afs, alert) {
        this.fireAuth = fireAuth;
        this.afs = afs;
        this.alert = alert;
        this.user$ = this.fireAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])((user) => {
            if (user) {
    ...
    sendVerificationEmail() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                return (yield this.fireAuth.currentUser).sendEmailVerification();
            }
            catch (error) {
    ...
    loginGoogle() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const { user } = yield this.fireAuth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_3__["default"].auth.GoogleAuthProvider);
    ...
    register(email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const { user } = yield this.fireAuth.createUserWithEmailAndPassword(email, password);
    ...
    login(email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const { user } = yield this.fireAuth.signInWithEmailAndPassword(email, password);
                this.updateUserData(user);
                return user;
            }
            catch (error) {
    ...
    getError(errorCode) {
        ...
        if (errorCode == 'auth/invalid-email')
            this.presentRegisterAlert(1);
        // Contraseña incorrecta
        if (errorCode == 'auth/wrong-password')
            this.presentRegisterAlert(2);
        // Correo en uso
        if (errorCode == 'auth/email-already-in-use')
            this.presentRegisterAlert(3);
        // Usuario no encontrado
        if (errorCode == 'auth/user-not-found')
            this.presentRegisterAlert(4);
        // Contraseña débil
        if (errorCode == 'auth/weak-password')
            this.presentRegisterAlert(5);
    }
    // Alert para informar al usuario de los problemas que han ocurrido al registrar su correo
    presentRegisterAlert(errorCode) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            // Correo no válido
            if (errorCode == 1) {
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-ofertas-articulos-ofertas-articulos-module */[__webpack_require__.e("common"), __webpack_require__.e("ofertas-articulos-ofertas-articulos-module")]).then(__webpack_require__.bind(null, /*! ./pages/ofertas-articulos/ofertas-articulos.module */ "evj9")).then(m => m.OfertasArticulosPageModule),
        canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'verify-email',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-verify-email-verify-email-module */ "pages-verify-email-verify-email-module").then(__webpack_require__.bind(null, /*! ./pages/verify-email/verify-email.module */ "lXXe")).then(m => m.VerifyEmailPageModule)
    },
    {
        path: 'forgot-pwd',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-forgot-pwd-forgot-pwd-module */ "pages-forgot-pwd-forgot-pwd-module").then(__webpack_require__.bind(null, /*! ./pages/forgot-pwd/forgot-pwd.module */ "hSO8")).then(m => m.ForgotPwdPageModule)
    },
    {
        path: 'tabs',
    ...
    {
        path: 'pedidos',
        loadChildren: () => Promise.all(/*! import() | pages-pedidos-pedidos-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-pedidos-pedidos-module")]).then(__webpack_require__.bind(null, /*! ./pages/pedidos/pedidos.module */ "u+uD")).then(m => m.PedidosPageModule)
    },
    {
        path: 'caja',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-caja-caja-module */ "caja-caja-module").then(__webpack_require__.bind(null, /*! ./pages/caja/caja.module */ "paSx")).then(m => m.CajaPageModule)
    },
    {
        path: 'modal-articulo',
        loadChildren: () => Promise.all(/*! import() | pages-modal-articulo-modal-articulo-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-modal-articulo-modal-articulo-module")]).then(__webpack_require__.bind(null, /*! ./pages/modal-articulo/modal-articulo.module */ "fVom")).then(m => m.ModalArticuloPageModule)
    },
    {
        path: 'modal-oferta',
        loadChildren: () => Promise.all(/*! import() | pages-modal-oferta-modal-oferta-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-modal-oferta-modal-oferta-module")]).then(__webpack_require__.bind(null, /*! ./pages/modal-oferta/modal-oferta.module */ "l0jK")).then(m => m.ModalOfertaPageModule)
    },
];
